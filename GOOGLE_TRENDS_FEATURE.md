...
YouTube 인기 페이지에 **구글 트렌드** 탭이 추가되었습니다. 실시간으로 한국에서 가장 핫한 검색어와 뉴스를 확인하고, 바로 YouTube에서 관련 영상을 검색할 수 있습니다.
...
- `src/main/resources/templates/youtube/fragments/youtube-filters.html` - 탭 메뉴 업데이트
