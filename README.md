...
6. **공고 선택**: 관심있는 공고 번호 입력 (예: 1번)
7. **기술 스택 입력**: 보유 기술 스택 입력 (예: Java, Spring Boot, AWS)
8. **모의 면접 진행**: 5개의 면접 질문에 답변
9. **합격률 확인**: 종합 평가 및 합격 예상률 확인
...
### 포지션별 면접 질문
- **백엔드 개발자**: JVM, Spring, RESTful API, 문제 해결 등
- **프론트엔드 개발자**: React, JavaScript, 웹 성능 최적화 등
- **풀스택 개발자**: 전반적인 개발 역량 평가
- **DevOps 엔지니어**: CI/CD, Docker, Kubernetes, AWS 등
...
챗봇: 🎉 총 5개의 채용 공고를 찾았습니다!
      ...
      💡 번호를 입력하시면 모의 면접을 진행할 수 있습니다!

사용자: 1번 면접보고 싶어요
챗봇: '네이버 - 백엔드 개발자' 포지션을 선택하셨네요!
      보유하신 기술 스택을 알려주세요.

사용자: Java, Spring Boot, MySQL, AWS
챗봇: 🎤 모의 면접을 시작하겠습니다!
