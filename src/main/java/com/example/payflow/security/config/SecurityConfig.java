    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/youtube/**").permitAll()  // YouTube 웹 페이지 허용 (trends 포함)
                        .requestMatchers("/api/youtube/popular/**", "/api/youtube/statistics/**", "/api/youtube/top-viewed", "/api/youtube/top-liked", "/api/youtube/search", "/api/youtube/revenue/**", "/api/youtube/channels/**", "/api/youtube/hot-channels", "/api/youtube/trends", "/api/youtube/analysis/**").permitAll()  // YouTube 공개 API
